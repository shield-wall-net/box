...
PROXY_ARGS="--fqdn=${UUID}.box.shieldwall --proxy-url=http://controller.shieldwall:900 --metrics-addr=:9369 --log.level=warn"
# shellcheck disable=SC2086
/usr/local/bin/prometheus_pushproxy_client $PROXY_ARGS &
...
METRICS_ARGS='--log.level=warn --web.listen-address=:9100'
